...
def generate_analytics_dashboard():
    ...
    # 2. Instructor Popularity (Horizontal Bar Chart)
    ...
    # 3. Department Load Analysis (Pie Chart)
    ...
    # 4. Seat Utilization (Bar Chart with threshold line)
    ...
    # 5. Credit Distribution (Histogram)
